...
Ruolo = placeholderRuolo.text_area("Ruolo giocatore", "")
Cognome = placeholderCognome.text_area("Cognome giocatore", "")
Squadra = placeholderSquadra.text_area("Squadra giocatore", "")
